...
/* Social login button — non-functional, shows "Coming soon" tooltip */
  ...
  return (
    <div style={{ position: 'relative', flex: 1 }}>
      <button
        ...
        onMouseEnter2={(e) => (e.currentTarget.style.background = 'var(--bg-card-hover)')}
        onMouseLeave2={(e) => (e.currentTarget.style.background = 'var(--bg-elevated)')}
      >
        {logo}{label}
      </button>
      {tip && (
  ...
  return (
    <div style={{ width: '100%', maxWidth: 420 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 36 }}>
        ...
        <span style={{ fontWeight: 700, fontSize: 20, color: 'var(--text-primary)', fontFamily: 'DM Sans' }}>
          InsightAI
        </span>
      </div>

      {/* Heading */}
      <h1 style={{ margin: '0 0 6px', fontSize: 28, fontWeight: 700, color: 'var(--text-primary)', fontFamily: 'DM Sans' }}>
        Welcome back
      </h1>
      ...
      <form onSubmit={handleSubmit} noValidate style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <button type="button"
            style={{ background: 'none', border: 'none', fontSize: 13, color: 'var(--accent-light)', cursor: 'pointer', fontFamily: 'DM Sans', fontWeight: 500 }}>
            Forgot password?
          </button>
        </div>
